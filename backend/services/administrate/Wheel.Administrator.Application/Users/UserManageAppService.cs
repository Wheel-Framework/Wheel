...
{
    public class UserManageAppService(IBasicRepository<BackendUser, string> userRepository, BackendUserManager userManager,
            IUserStore<BackendUser> userStore)
        : AdministratorServiceBase, IUserManageAppService
    {

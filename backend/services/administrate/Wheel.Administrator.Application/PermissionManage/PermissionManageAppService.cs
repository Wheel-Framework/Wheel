...
namespace Wheel.Administrator.Services.PermissionManage
{
    public class PermissionManageAppService(XmlCommentHelper xmlCommentHelper,
            IBasicRepository<PermissionGrant, Guid> permissionGrantRepository, RoleManager<BackendRole> roleManager)
        : AdministratorServiceBase, IPermissionManageAppService
    {

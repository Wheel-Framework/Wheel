...
{
    public class EFBasicRepository<TEntity, TKey>(AdministratorDbContext dbContext) : IBasicRepository<TEntity, TKey>
        where TEntity : class
    {
    ...
    public class EFBasicRepository<TEntity>(AdministratorDbContext dbContext) : EFBasicRepository<TEntity, object>(dbContext),

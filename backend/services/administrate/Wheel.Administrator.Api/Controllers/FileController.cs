...
using Wheel.Administrator.Services.FileStorageManage;
...
namespace Wheel.Administrator.Controllers
{
    ...
    [ApiController]
    public class FileController(IFileStorageManageAppService fileStorageManageAppService) : AdministratorControllerBase
    {
        /// <summary>
        /// 分页查询列表
        /// </summary>

...
namespace Wheel.Migrations
{
    ...
    [Migration("20231020014332_Add_FileStorage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wheel.Domain.FileStorages.FileStorage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Wheel.Domain.Identity.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 20, 9, 43, 31, 836, DateTimeKind.Unspecified).AddTicks(2947), new TimeSpan(0, 8, 0, 0, 0)));
